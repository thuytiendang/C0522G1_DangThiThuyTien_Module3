        ...
        <form class="w-50 border border-2 border-success p-3 bg-warning rounded" action="/employee?action=create"
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" id="name" class="form-control" placeholder="Input name" name="employeeName">
            ...
            <div class="mt-3 form-group">
                ...
                <input type="date" id="dateOfBirth" class="form-control" name="employeeBirthday">
            </div>

            <div class="mt-3 form-group">
                <label for="idCard" class="h6">Identity card:</label>
                <div class="input-group">
                    <input type="text" id="idCard" class="form-control" placeholder="Input Id card" name="employeeIdCard">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="salary" class="form-control" placeholder="Input salary" name="employeeSalary">
                    <span class="input-group-text"><i class="fa-solid fa-id-card"></i></span>
                </div>
            </div>
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="phone" class="form-control" placeholder="Input Phone number" name="employeePhone">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="email" class="form-control" placeholder="Input Email" name="employeeEmail">
            ...
            <div class="mt-3 form-group">
                ...
                <div class="input-group">
                    <input type="text" id="address" class="form-control" placeholder="Input Address" name="employeeAddress">
